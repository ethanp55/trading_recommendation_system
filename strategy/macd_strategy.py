...
class MACDStrategy(Strategy):
    ...
    def place_trade(self, curr_idx: int, market_data: DataFrame) -> Optional[Trade]:
        macd2, macdsignal2 = market_data.loc[market_data.index[curr_idx - 2], ['macd', 'macdsignal']]
        macd1, macdsignal1, ema200_1, ema100_1 = market_data.loc[market_data.index[curr_idx - 1],
                                                                 ['macd', 'macdsignal', 'ema200', 'ema100']]
        ...
        buy_signal = macd2 < macdsignal2 and macd1 > macdsignal1 and max(macd_vals) == 0 and ema100_1 > ema200_1
        sell_signal = macd2 > macdsignal2 and macd1 < macdsignal1 and min(macd_vals) == 0 and ema100_1 < ema200_1
